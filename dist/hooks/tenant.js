...
var createTenantAfterChangeHook = function (_a) {
    ...
    return function (_a) {
        var doc = _a.doc, operation = _a.operation, payload = _a.req.payload;
        return __awaiter(void 0, void 0, void 0, function () {
            var tenantCount, authCollections, _i, authCollections_1, collection, users, _b, users_1, id;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (operation !== "create")
                            return [2 /*return*/];
                        return [4 /*yield*/, payload.find({ collection: tenantCollection, limit: 0 })];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, payload.find({ collection: collection })];
                    case 3:
                        users = (_d.sent()).docs;
                        _b = 0, users_1 = users;
                        _d.label = 4;
